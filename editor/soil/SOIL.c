...
#define SOIL_CHECK_FOR_GL_ERRORS 0
	...
	#include <wingdi.h>
	//#include <GL/gl.h>
	// USE GLEW DEFINITIONS, ruell
	// TODO: use definitions for EGL -- mobile
...
#endif
		/* 
		MOdified by Ruell to use GLEW instead 
		Explanation in here: 
		http://gamedev.stackexchange.com/questions/64103/exception-at-0x53c227ff-msvcr110d-dll-with-soil-library
		*/
		GLint n=0; 
		int found = 0;
		int i = 0;
