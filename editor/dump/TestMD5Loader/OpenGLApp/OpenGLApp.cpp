...
void Init()
{
	//...
	shader.Init();
	shader.LoadVertexShaderFromFile("shaders/md5_vshader.txt");
	shader.LoadFragmentShaderFromFile("shaders/md5_fshader.txt");
	shader.Build();
	...
	model.LoadFromFile("boblampclean.md5mesh","model");
	model.AddAnimation("model/boblampclean.md5anim");
	model.BakeMesh();
}
